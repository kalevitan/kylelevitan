...
export const SEO_CONFIG = {
  ...
  defaultDescription: 'Kyle Levitan is a skilled web developer and designer based in Asheville, NC, specializing in React, and Next.js, Drupal, WordPress, Symfony, and more. Offering professional solutions for custom websites, applications, and content management systems.',
  defaultKeywords: 'Kyle Levitan, web developer, web designer, full-stack developer, React, Next.js, Drupal, WordPress, Symfony, web development Asheville, CMS development, front-end, back-end, applications, custom websites',
  author: 'Kyle Levitan',
